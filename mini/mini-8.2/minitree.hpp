...
class minitree
   ...
   //! default constructor
   minitree(minicache *cache,minitile *terrain);
   ...
   static void prismedge(float x,float y,float yf,float z);
   static void prismcache(int phase,float scale,float ex,float ey,float ez);
   static int prismrender(float *cache,int cnt,float lambda);
   static int trigger(int phase);
   ...
   int rendertrees(float *cache,float *coords,int cnt,float lambda,
